...
set_pairs = [
    ...
    [r"what is your name?", ["You can call me Friday",]],
    ...
    [
        ...
        [
            "Pluralsight, Udemy are great options to learn data science. You can check their website",
        ],
    ],
    [
...
def chatbot():
    print("Hi, I am the chatbot you built!")
